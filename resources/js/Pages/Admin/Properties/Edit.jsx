...
export default function Edit({ property, auth }) {
    ...
    const handleSubmit = (e) => {
        ...
        patch(route('admin.properties.update', property.id), {
            onSuccess: () => {
    ...
    return (
        <AdminLayout
            header={`Edit Property: ${property.name}`}
        >
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8 rounded-lg bg-gradient-to-r from-primary-700 to-primary-600 p-6 shadow-lg transition-all duration-500" style={{ 
                        ...
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div>
                                <h1 className="text-2xl font-medium text-white">Edit Property</h1>
